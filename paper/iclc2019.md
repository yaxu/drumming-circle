---
title: Pattern, Code and Algorithmic Drumming Circles, A Report
author:
  - name: Alex McLean
...
an installation at the Playgrounds exhibition in Sheffield, Yorkshire
UK. It was planned to work with year 6s (Y6; 10-11 year olds), but in
the last stages it turned out they were unavailable, and so year 4
(8-9 year olds) stepped in. In addition three year 8 (Y8; 12-13 year
olds) pupils were available for more focussed work. Ten days were
available to develop the whole activity.
...
example hands-on. Syntax errors did crop up, whereupon the child would
stick their hand up for me to come round and help them fix their code.
...
of the group, which created a rich percussive emsemble. My original
...
provided constraints to encourage them to work creatively with the
patterns.
...
Childrens' Media Conference. The computers were set up on the floor of
the exhibition, as they were in the school, only without keyboards,
creating a non-interactive installation. The videos of originally
taken from a camera attached to the ceiling in the school were
projected back onto the computers from a projector suspended above, so
that ghostly images of the children could be seen moving around and
working at the computers. The childrens' keypresses were
...
them. Small booklets were made to explaining how the project worked,
and its motivations.

The projection could have been a little brighter, and the acoustics of
the room a little more dryer, but the children did an amazing job, and
this came through well in installation form. The children themselves
visited the gallery, and reports are that they enjoyed re-watching
their drumming circles (and stepping on each other's projected forms).
...
view to exploring tactile interfaces through participatory design, but
the visual impairments of the participants was not a factor in the
present project. We had around five hours of learning and practice
over two sessions together, together with their more advanced years
allowing a much wider exploration of Tidal's functions and sounds. We
also recorded new sounds for the children to use. I joined them in the
performance, forming a live code quartet, to a large audience largely
consisting of pupils from another local primary school. The live
...
they all engaged fully with the activity throughout, and to my own
ears, the musical results were extremely good, fluctuating between
polyrhythmic grooves and extreme noise, with each drumming circle
having a distinct character. It was particularly nice to see children
hear something interesting one of their friends was making, run round
to have a look at how it was done, and then run back to try it out
themselves. 

Further development is ongoing towards a follow-on installation. I am
particularly keen to make the next iteration interactive, providing an
additional computer or two allowing visitors to join in with the live
